...
- Criado `docs/ADDING_NEW_ADVENTURE.md`, com fluxo para definir promessa narrativa, escolher template, escrever cenas, configurar revisao dos pais, preparar assets/audio, validar e abrir PR.
...
- Usar `docs/ADDING_NEW_ADVENTURE.md` como checklist oficial quando a proxima aventura for criada.
